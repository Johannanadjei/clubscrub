...
import { Home, Calendar, User, LayoutDashboard, ChevronLeft, Star } from 'lucide-react'
...
export function CustomerNav() {
  ...
  const tabs = [
    ...
    { path: '/dashboard', icon: Calendar, label: 'Bookings' },
    { path: '/book', icon: null, label: 'Book', primary: true },
    { path: '/assistant', icon: User, label: 'Assistant' },
